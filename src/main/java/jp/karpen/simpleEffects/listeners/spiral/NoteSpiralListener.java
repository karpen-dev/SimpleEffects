...
public final class NoteSpiralListener extends AbstractEffectListener {
    public NoteSpiralListener(FileManager fileManager) {
        super(Type.NOTE_SPIRAL, fileManager);
    }
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        if (enabledPlayers.contains(player.getUniqueId())) {
            Bukkit.getScheduler().runTaskTimer(plugin, (r) -> {
                ...
                spawnParticleSpiral(player, Particle.NOTE);
            }, 0L, 20L);
        }
    }
