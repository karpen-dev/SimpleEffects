...
public final class PurpleSpiralListener extends AbstractEffectListener {
    public PurpleSpiralListener(FileManager fileManager) {
        super(Type.PURPLE_SPIRAL, fileManager);
    }
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        if (enabledPlayers.contains(player.getUniqueId())) {
            Bukkit.getScheduler().runTaskTimer(plugin, (r) -> {
                ...
                spawnParticleSpiral(player, Particle.WITCH);
            }, 0L, 20L);
        }
    }
