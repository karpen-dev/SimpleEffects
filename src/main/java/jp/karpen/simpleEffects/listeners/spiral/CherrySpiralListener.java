...
public final class CherrySpiralListener extends AbstractEffectListener {

    public CherrySpiralListener(FileManager fileManager) {
        super(Type.CHERRY_SPIRAL, fileManager);
    }
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        if (enabledPlayers.contains(player.getUniqueId())) {
            Bukkit.getScheduler().runTaskTimer(plugin, (r) -> {
                ...
                spawnParticleSpiral(player, Particle.CHERRY_LEAVES);
            }, 0L, 20L);
        }
    }
