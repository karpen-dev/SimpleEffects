...
public final class TotemSpiralListener extends AbstractEffectListener {

    public TotemSpiralListener(FileManager fileManager) {
        super(Type.TOTEM_SPIRAL, fileManager);
    }
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        if (enabledPlayers.contains(player.getUniqueId())) {
            Bukkit.getScheduler().runTaskTimer(plugin, (r) -> {
                ...
                spawnParticleSpiral(player, Particle.TOTEM_OF_UNDYING);
            }, 0L, 20L);
        }
    }
