...
public final class NoteListener extends AbstractEffectListener {
    public NoteListener (FileManager fileManager) {
        super(Type.NOTE, fileManager);
    }
    ...
    public void onPlayerMove(PlayerMoveEvent event) {
        ...
        if (enabledPlayers.contains(player.getUniqueId())) {
            ...
            spawnParticleTrail(player, Particle.NOTE);
        }
    }
