...
public final class HeartListener extends AbstractEffectListener {
    public HeartListener (FileManager fileManager) {
        super(Type.HEART, fileManager);
    }
    ...
    public void onPlayerMove(PlayerMoveEvent event) {
        ...
        if (enabledPlayers.contains(player.getUniqueId())) {
            ...
            spawnParticleTrail(player, Particle.HEART);
        }
    }
